...
class Blogs extends Component {
    ...
    render() {
        ...
        let blogs = this.state.data.map(val=>{
                    ...
                    <div className="row m-0">
                        ...
                        <Button color="link" className={'blog-view p-0 pl-2'}>  <a href={`${val.blog_view_link}`} target="_blank">View</a></Button>
                            ...
                            {/* <div className="col-sm-6">
                                ...
                                <a className="like-btn" ><i className={`far fa-thumbs-up thumbs-up-black`} style={{fontSize:'18px'}}></i></a>
                                </span>
                            </div> */}
                            </div>
                        </CardBody>
        ...
        return (
            <div className="container-fuild blogs" id="results">
               ...
               {blogs.reverse().slice(0,6)}
                             ...
                             <div className="text-center view-more"><Link to={'/blogs'} >View More</Link></div>
            </div>
        );
    }
    }
